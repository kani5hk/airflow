...
class FileTaskHandlerWithCustomFormattor(FileTaskHandler):
    """
    FileTaskHandlerWithCustomFormattor is a python log handler that
    ...
    def __init__(self, base_log_folder, filename_template):
        super(FileTaskHandlerWithCustomFormattor, self).__init__(base_log_folder, filename_template)
